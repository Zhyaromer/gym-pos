...
const TransactionView = () => {
  ...
  const handleSaveItem = async (itemData) => {
    ...
    const data = {
      total_amount: updatedTransaction.total_amount?.toFixed(3),
      final_amount: updatedTransaction.final_amount?.toFixed(3),
      item_id: itemData.item_id,
      transaction_orderNumber: transaction.transaction_orderNumber,
    }

    // const res = await axios.post('http://localhost:3000/reception/update_item', updatedTransaction);
